...
const WhishList = ({ cartItems, updateCartItem, removeCartItem }) => {
  ...
  return (
    <div>
      <div className="flex flex-col items-center my-10">
        <h2 className="text-2xl font-bold text-center mt-4">My Wishlist</h2>
            ...
            {localCartItems.length > 0 ? (
              <div>
                ...
                <div className="hidden lg:flex justify-between items-center border-b pb-2 mb-2">
                  ...
                  <div className="mr-[6vw]">Stock Status</div>
                </div>
                {/* Cart items */}
                ...
                {localCartItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/6 mb-2 ml-60 lg:mb-0 flex justify-center lg:justify-start">
                      <TiTimes
                        style={{ borderRadius: "20px" }}
                        className="text-xl cursor-pointer border-2 text-gray-600"
